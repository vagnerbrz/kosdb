    ...
    <div class="flex flex-col">
        <div class="justify-items-center">
            <h4
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r to-green-400 from-sky-400">Heros</span>
            </h4>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-zinc-500 md:ms-2 dark:text-zinc-400">Heros</span>
                        </div>
                    </li>
                </ol>
            </nav>
